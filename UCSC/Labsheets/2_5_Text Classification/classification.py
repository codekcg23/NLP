...
def train_predict_evaluate_model(classifier,
                                 ...
                                 test_features, test_labels, name):
    # build model
...
mnb_bow_predictions = train_predict_evaluate_model(classifier=mnb,
                                                   ...
                                                   test_labels=test_labels, name='mnb_bow')
...
svm_bow_predictions = train_predict_evaluate_model(classifier=svm,
                                                   ...
                                                   train_labels=train_labels,
                                                   test_features=bow_test_features,
                                                   test_labels=test_labels, name ='svm_bow')
...
mnb_tfidf_predictions = train_predict_evaluate_model(classifier=mnb,
                                                     ...
                                                     test_labels=test_labels, name ='mnb_tfidf')
...
svm_tfidf_predictions = train_predict_evaluate_model(classifier=svm,
                                                     ...
                                                     train_labels=train_labels,
                                                     test_features=tfidf_test_features,
                                                     test_labels=test_labels,name='svm_tdidf')
...
svm_avgwv_predictions = train_predict_evaluate_model(classifier=svm,
                                                     ...
                                                     test_labels=test_labels, name = 'svm_avgwv')
...
svm_tfidfwv_predictions = train_predict_evaluate_model(classifier=svm,
                                                       ...
                                                       test_labels=test_labels, name ='svm_tfidfwv' )
